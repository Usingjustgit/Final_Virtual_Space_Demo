...
export class UserController {
   ...
   */
  @Post('/register')
  async createUser(@Body() user: User): Promise<RegisterUser> {
  ...
  /**
   * Retrieves the private videos of the currently authenticated user.
   * @param req - The request object containing user information.
   * @returns A Promise with an array of private videos.
   */
  @Get('/private/video')
  @UseGuards(AuthGuard('jwt'))
  async getPrivateVideos(@Req() req): Promise<TypeOfVideos[] | string[]> {
    const userId = req.user._id;
    return await this.userService.getPrivateVideos(userId);
  }
